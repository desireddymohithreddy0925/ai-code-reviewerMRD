...
async def run_batch_pipeline(
    ...
    print(f"⏳ Dispatching Security, Performance, Style, Profiling, Impact, Test, Architecture, and Historical Bug agents concurrently...")
    ...
    security_res, performance_res, style_res, profiling_res, impact_res, test_res, arch_res, historical_res = results
