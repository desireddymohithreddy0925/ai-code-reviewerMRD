...
async def run_batch_pipeline(
    ...
    print(f"⏳ Dispatching Security, Performance, Style, Impact, and Historical Bug agents concurrently...")
    ...
    security_res, performance_res, style_res, impact_res, historical_res = results
